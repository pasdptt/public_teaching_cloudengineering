...
Sits in **week 4**, in the discussion block. 10–15 minutes. Covers **weeks 1–3** only —
never same-day material. Outcomes: **CLO-1, CLO-2, CLO-3 (introductory)**.
...
The answer key lives in the private repository at `quiz-keys/quiz-02-key.md` and must
