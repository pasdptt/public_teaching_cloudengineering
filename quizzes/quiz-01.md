...
Sits in **week 2**, in the discussion block. 10–15 minutes. Covers **week 1** only —
never same-day material. Outcomes: **CLO-1, CLO-2 (introductory)**.
...
The answer key lives in the private repository at `quiz-keys/quiz-01-key.md` and must
